...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-white/75 bg-white/82 shadow-[0_24px_60px_rgba(17,36,25,0.12)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="p-8 sm:p-10">
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="mt-1 text-slate-500">Sign in to your NyumbaSwift account</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 py-3 text-slate-700 outline-none transition focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100"
                    required
                  />
                </div>
              </div>
